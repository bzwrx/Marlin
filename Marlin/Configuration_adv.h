...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_2 "Reset Z "
  #define USER_GCODE_2 "G92 Z0"

  #define USER_DESC_3 "Reset X and Y"
  #define USER_GCODE_3 "G92 X0 Y0"

  #define USER_DESC_4 "Enable X and Y"
  #define USER_GCODE_4 "M17 X0 Y0"

  #define USER_DESC_5 "Disable X and Y"
  #define USER_GCODE_5 "M18 X0 Y0"

  #define USER_DESC_6 "Enable Z"
  #define USER_GCODE_6 "M17 Z0"

  #define USER_DESC_7 "Disable Z"
  #define USER_GCODE_7 "M18 Z0"
